...
import ccsdg.models.unet_ccsdg as uc
...
class SimpleNet(nn.Module):
    ...
    def __init__(self, cfg, model_cfg, num_classes, **kwargs):
        ...
        self.dom_discr = nn.Linear(fdim, len(cfg.DATASET.SOURCE_DOMAINS))
...
class SimpleTrainer(TrainerBase):
    ...
    def build_model(self):
        ...
        self.model = uc.UNetCCSDG(resnet='resnet18', num_classes=self.num_classes, pretrained=True)
        self.model.to(self.device)

        self.projector = uc.Projector()
...
class CCSDGVanilla(TrainerX):
    ...
    def forward_backward(self, batch):
        ...
        f_content, f_style = self.model.forward_first_layer(input, tau=0.1)
        f_content_fda, f_style_fda = self.model.forward_first_layer(fda, tau=0.1)
        f_content_GLA, f_style_GLA = self.model.forward_first_layer(gla, tau=0.1)
        ...
        # loss = loss_fda + loss_gla + loss_base
